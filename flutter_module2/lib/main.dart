  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // home: const MyHomePage(title: 'Flutter Demo Home Page 2'),
        ...
        routes: {
          "/second1": (constext) => MyHomePage1(title: 'Flutter Demo Home Page First'),
          "/second2": (context) => RechargeDashBoard2(),
    ...
    return Scaffold(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            RaisedButton(
              ...
              onPressed: () {
                _counter++;
                _callMethodChannel(context, 'callback', '2 callback value $_counter');
              },
            ...
            RaisedButton(
              ...
              onPressed: () {
                _callMethodChannel(context, 'ScreenCallback', <String, dynamic>{
                  // 'first': '2 ScreenCallback value $_counter',
                  'second': '2 ScreenCallback value ${_counter + _counter}',
                });
              },
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => RechargeDashBoard2()),
          );
        },
        tooltip: 'Increment',
